...
package alexsocol.asjlib.preconfig;
...
import static alexsocol.asjlib.preconfig.PreProperty.Type.*;

/**
 * This class offers advanced configurations capabilities, allowing to provide
 * various categories for configuration variables.
 */
@SuppressWarnings("ALL") // STFU - I'm not refactoring this shit
public class PreConfiguration {
	...
	private static PreConfiguration PARENT = null;
	
	File file;
	
	private Map<String, PreConfigCategory> categories = new TreeMap<String, PreConfigCategory>();
	private Map<String, PreConfiguration> children = new TreeMap<String, PreConfiguration>();
	 ...
	 */
	public PreConfiguration(File file) {
		this(file, null);
	}
	 ...
	 */
	public PreConfiguration(File file, String configVersion) {
		this.file = file;
	...
	public PreConfiguration(File file, String configVersion, boolean caseSensitiveCustomCategories) {
		this(file, configVersion);
		this.caseSensitiveCustomCategories = caseSensitiveCustomCategories;
	}
	
	public PreConfiguration(File file, boolean caseSensitiveCustomCategories) {
	 ...
	 */
	public PreProperty get(String category, String key, boolean defaultValue) {
	 ...
	 * @return a boolean Property object without a comment
	 */
	public PreProperty get(String category, String key, boolean defaultValue, String comment) {
		PreProperty prop = get(category, key, Boolean.toString(defaultValue), comment, BOOLEAN);
	 ...
	 */
	public PreProperty get(String category, String key, boolean[] defaultValues) {
	 ...
	 */
	public PreProperty get(String category, String key, boolean[] defaultValues, String comment) {
	...
	public PreProperty get(String category, String key, boolean[] defaultValues, String comment,
		...
		PreProperty prop = get(category, key, values, comment, BOOLEAN);
	 ...
	 */
	public PreProperty get(String category, String key, int defaultValue) {
	 ...
	 * @return an integer Property object with default bounds of Integer.MIN_VALUE and Integer.MAX_VALUE
	 */
	public PreProperty get(String category, String key, int defaultValue, String comment) {
	 ...
	 */
	public PreProperty get(String category, String key, int defaultValue, String comment, int minValue, int maxValue) {
		PreProperty prop = get(category, key, Integer.toString(defaultValue), comment, INTEGER);
	 ...
	 * maxListLength = -1
	 */
	public PreProperty get(String category, String key, int[] defaultValues) {
		return get(category, key, defaultValues, (String) null);
	}
	 ...
	 * maxListLength = -1
	 */
	public PreProperty get(String category, String key, int[] defaultValues, String comment) {
	 ...
	 */
	public PreProperty get(String category, String key, int[] defaultValues, String comment, int minValue, int maxValue) {
	...
	public PreProperty get(String category, String key, int[] defaultValues, String comment, int minValue, int maxValue,
		...
		PreProperty prop = get(category, key, values, comment, INTEGER);
		prop.setDefaultValues(values);
		prop.setMinValue(minValue);
		prop.setMaxValue(maxValue);
		prop.setIsListLengthFixed(isListLengthFixed);
	 ...
	 */
	public PreProperty get(String category, String key, double defaultValue) {
		return get(category, key, defaultValue, (String) null);
	}
	 ...
	 * @return a double Property object with default bounds of Double.MIN_VALUE and Double.MAX_VALUE
	 */
	public PreProperty get(String category, String key, double defaultValue, String comment) {
	 ...
	 */
	public PreProperty get(String category, String key, double defaultValue, String comment, double minValue, double maxValue) {
		PreProperty prop = get(category, key, Double.toString(defaultValue), comment, DOUBLE);
	 ...
	 * maxListLength = -1
	 */
	public PreProperty get(String category, String key, double[] defaultValues) {
	 ...
	 * maxListLength = -1
	 */
	public PreProperty get(String category, String key, double[] defaultValues, String comment) {
	 ...
	 * false, maxListLength = -1
	 */
	public PreProperty get(String category, String key, double[] defaultValues, String comment, double minValue, double maxValue) {
		return get(category, key, defaultValues, comment, minValue, maxValue, false, -1);
	}
	...
	public PreProperty get(String category, String key, double[] defaultValues, String comment, double minValue, double maxValue,
		...
		PreProperty prop = get(category, key, values, comment, DOUBLE);
		prop.setDefaultValues(values);
		prop.setMinValue(minValue);
		prop.setMaxValue(maxValue);
		prop.setIsListLengthFixed(isListLengthFixed);
	 ...
	 */
	public PreProperty get(String category, String key, String defaultValue) {
		return get(category, key, defaultValue, (String) null);
	}
	 ...
	 * @return a string Property with validationPattern = null, validValues = null
	 */
	public PreProperty get(String category, String key, String defaultValue, String comment) {
	 ...
	 */
	public PreProperty get(String category, String key, String defaultValue, String comment, Pattern validationPattern) {
		PreProperty prop = get(category, key, defaultValue, comment, STRING);
	 ...
	 */
	public PreProperty get(String category, String key, String defaultValue, String comment, String[] validValues) {
		PreProperty prop = get(category, key, defaultValue, comment, STRING);
	 ...
	 */
	public PreProperty get(String category, String key, String[] defaultValues) {
	 ...
	 * @return a string array Property with validationPattern = null, isListLengthFixed = false, maxListLength = -1
	 */
	public PreProperty get(String category, String key, String[] defaultValues, String comment) {
	 ...
	 */
	public PreProperty get(String category, String key, String[] defaultValues, String comment, Pattern validationPattern) {
	...
	public PreProperty get(String category, String key, String[] defaultValues, String comment,
		...
		PreProperty prop = get(category, key, defaultValues, comment, STRING);
		prop.setIsListLengthFixed(isListLengthFixed);
		prop.setMaxListLength(maxListLength);
		prop.setValidationPattern(validationPattern);
		return prop;
	 ...
	 */
	public PreProperty get(String category, String key, String defaultValue, String comment, PreProperty.Type type) {
		if (!caseSensitiveCustomCategories) {
			category = category.toLowerCase(Locale.ENGLISH);
		}
		
		PreConfigCategory cat = getCategory(category);
		
		if (cat.containsKey(key)) {
			PreProperty prop = cat.get(key);
			
			if (prop.getType() == null) {
				prop = new PreProperty(prop.getName(), prop.getString(), type);
				cat.put(key, prop);
			}
			...
			PreProperty prop = new PreProperty(key, defaultValue, type);
	 ...
	 */
	public PreProperty get(String category, String key, String[] defaultValues, String comment, PreProperty.Type type) {
		if (!caseSensitiveCustomCategories) {
			category = category.toLowerCase(Locale.ENGLISH);
		}
		...
		if (cat.containsKey(key)) {
			...
			PreProperty prop = new PreProperty(key, defaultValues, type);
			prop.setDefaultValues(defaultValues);
			prop.comment = comment;
			cat.put(key, prop);
			return prop;
	...
	public boolean hasKey(String category, String key) {
		PreConfigCategory cat = categories.get(category);
	...
	public void load() {
		...
		try {
			...
			if (file.canRead()) {
				...
				String line;
				PreConfigCategory currentCat = null;
				PreProperty.Type type = null;
				...
				while (true) {
					...
					if (start.matches()) {
						...
						categories = new TreeMap<String, PreConfigCategory>();
						continue;
					} else if (end.matches()) {
						fileName = end.group(1);
						PreConfiguration child = new PreConfiguration();
						...
						if (Character.isLetterOrDigit(line.charAt(i)) || ALLOWED_CHARS.indexOf(line.charAt(i)) != -1 || (quoted && line.charAt(i) != '"')) {
							...
							switch (line.charAt(i)) {
								...
								case '{':
									...
									String qualifiedName = PreConfigCategory.getQualifiedName(name, currentCat);
									
									PreConfigCategory cat = categories.get(qualifiedName);
									if (cat == null) {
										currentCat = new PreConfigCategory(name, currentCat);
								...
								case '=':
									...
									PreProperty prop = new PreProperty(name, line.substring(i + 1), type, true);
									i = line.length();
								...
								case ':':
									if (tmpList != null) // allow special characters as part of string lists
										break;
									type = tryParse(line.substring(nameStart, nameEnd + 1).charAt(0));
									nameStart = nameEnd = -1;
									break;
								...
								case '>':
									...
									if (isFirstNonWhitespaceCharOnLine) {
										currentCat.put(name, new PreProperty(name, tmpList.toArray(new String[tmpList.size()]), type));
										name = null;
										tmpList = null;
										type = null;
		...
		try {
			...
			if (file.canWrite()) {
				...
				if (children.isEmpty()) {
					...
					for (Entry<String, PreConfiguration> entry : children.entrySet()) {
	...
	private void save(BufferedWriter out) throws IOException {
		for (PreConfigCategory cat : categories.values()) {
			if (!cat.isChild()) {
				cat.write(out, 0);
				out.newLine();
			}
	...
	public PreConfigCategory getCategory(String category) {
		PreConfigCategory ret = categories.get(category);
		
		if (ret == null) {
			if (category.contains(CATEGORY_SPLITTER)) {
				String[] hierarchy = category.split("\\" + CATEGORY_SPLITTER);
				PreConfigCategory parent = categories.get(hierarchy[0]);
				
				if (parent == null) {
					parent = new PreConfigCategory(hierarchy[0]);
					categories.put(parent.getQualifiedName(), parent);
					changed = true;
				}
				
				for (int i = 1; i < hierarchy.length; i++) {
					String name = PreConfigCategory.getQualifiedName(hierarchy[i], parent);
					PreConfigCategory child = categories.get(name);
					
					if (child == null) {
						child = new PreConfigCategory(hierarchy[i], parent);
				...
				ret = new PreConfigCategory(category);
	...
	public void removeCategory(PreConfigCategory category) {
		for (PreConfigCategory child : category.getChildren()) {
	 ...
	 * @param comment  a String comment
	 */
	public PreConfiguration setCategoryComment(String category, String comment) {
		if (!caseSensitiveCustomCategories)
			category = category.toLowerCase(Locale.ENGLISH);
	 ...
	 */
	public PreConfiguration setCategoryLanguageKey(String category, String langKey) {
		if (!caseSensitiveCustomCategories)
			category = category.toLowerCase(Locale.ENGLISH);
	 ...
	 */
	public PreConfiguration setCategoryConfigEntryClass(String category, Class<? extends IConfigEntry> clazz) {
	 ...
	 */
	public PreConfiguration setCategoryRequiresWorldRestart(String category, boolean requiresWorldRestart) {
		if (!caseSensitiveCustomCategories)
			category = category.toLowerCase(Locale.ENGLISH);
	 ...
	 */
	public PreConfiguration setCategoryRequiresMcRestart(String category, boolean requiresMcRestart) {
		if (!caseSensitiveCustomCategories)
			category = category.toLowerCase(Locale.ENGLISH);
	 ...
	 * config GUIs.
	 */
	public PreConfiguration setCategoryPropertyOrder(String category, List<String> propOrder) {
		if (!caseSensitiveCustomCategories)
			category = category.toLowerCase(Locale.ENGLISH);
	...
	private void setChild(String name, PreConfiguration child) {
		if (!children.containsKey(name)) {
			children.put(name, child);
			changed = true;
		} else {
			PreConfiguration old = children.get(name);
	...
	public static void enableGlobalConfig() {
		PARENT = new PreConfiguration(new File(Loader.instance().getConfigDir(), "global.cfg"));
		PARENT.load();
	}
	...
	public boolean hasChanged() {
		...
		for (PreConfiguration child : children.values()) {
	 ...
	 */
	public void copyCategoryProps(PreConfiguration fromConfig, String[] ctgys) {
		if (ctgys == null)
		...
		for (String ctgy : ctgys)
			if (fromConfig.hasCategory(ctgy) && this.hasCategory(ctgy)) {
				PreConfigCategory thiscc = this.getCategory(ctgy);
				PreConfigCategory fromcc = fromConfig.getCategory(ctgy);
				for (Entry<String, PreProperty> entry : thiscc.getValues().entrySet())
	...
	public String getString(String name, String category, String defaultValue, String comment, String langKey, Pattern pattern) {
		PreProperty prop = this.get(category, name, defaultValue);
	...
	public float getFloat(String name, String category, float defaultValue, float minValue, float maxValue, String comment, String langKey) {
		PreProperty prop = this.get(category, name, Float.toString(defaultValue), name);
		prop.setLanguageKey(langKey);
		prop.comment = comment + " [range: " + minValue + " ~ " + maxValue + ", default: " + defaultValue + "]";
		prop.setMinValue(minValue);
		prop.setMaxValue(maxValue);
