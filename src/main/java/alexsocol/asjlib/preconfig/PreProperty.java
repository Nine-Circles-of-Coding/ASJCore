...
public class PreProperty {
	...
	public PreProperty(String name, String value, Type type) {
		this(name, value, type, false, new String[0], name);
	}
	
	public PreProperty(String name, String value, Type type, boolean read) {
		this(name, value, type, read, new String[0], name);
	}
	
	public PreProperty(String name, String value, Type type, String[] validValues) {
		this(name, value, type, false, validValues, name);
	}
	
	public PreProperty(String name, String value, Type type, String langKey) {
		this(name, value, type, false, new String[0], langKey);
	}
	
	public PreProperty(String name, String value, Type type, boolean read, String langKey) {
		this(name, value, type, read, new String[0], langKey);
	}
	
	public PreProperty(String name, String value, Type type, String[] validValues, String langKey) {
		this(name, value, type, false, validValues, langKey);
	}
	
	PreProperty(String name, String value, Type type, boolean read, String[] validValues, String langKey) {
		setName(name);
		this.value = value;
	...
	public PreProperty(String name, String[] values, Type type) {
		this(name, values, type, false);
	}
	
	PreProperty(String name, String[] values, Type type, boolean read) {
		this(name, values, type, read, new String[0], name);
	}
	
	public PreProperty(String name, String[] values, Type type, String langKey) {
		this(name, values, type, false, langKey);
	}
	
	PreProperty(String name, String[] values, Type type, boolean read, String langKey) {
		this(name, values, type, read, new String[0], langKey);
	}
	
	PreProperty(String name, String[] values, Type type, boolean read, String[] validValues, String langKey) {
		setName(name);
		this.type = type;
	 ...
	 */
	public PreProperty setToDefault() {
	 ...
	 */
	public PreProperty setRequiresWorldRestart(boolean requiresWorldRestart) {
	 ...
	 * Defaults to true.
	 */
	public PreProperty setShowInGui(boolean showInGui) {
	 ...
	 * this property while a world is running.
	 */
	public PreProperty setRequiresMcRestart(boolean requiresMcRestart) {
	 ...
	 */
	public PreProperty setMaxListLength(int max) {
	 ...
	 */
	public PreProperty setIsListLengthFixed(boolean isListLengthFixed) {
	 ...
	 * will be provided).
	 */
	public PreProperty setConfigEntryClass(Class<? extends IConfigEntry> clazz) {
	 ...
	 */
	public PreProperty setArrayEntryClass(Class<? extends IArrayEntry> clazz) {
	 ...
	 */
	public PreProperty setValidationPattern(Pattern validationPattern) {
	 ...
	 */
	public PreProperty setLanguageKey(String langKey) {
		this.langKey = langKey;
		return this;
	}
	 ...
	 */
	public PreProperty setDefaultValue(String defaultValue) {
	 ...
	 */
	public PreProperty setDefaultValues(String[] defaultValues) {
		this.defaultValue = "";
	 ...
	 */
	public PreProperty setDefaultValue(int defaultValue) {
	 ...
	 */
	public PreProperty setDefaultValues(int[] defaultValues) {
	 ...
	 */
	public PreProperty setDefaultValue(double defaultValue) {
	 ...
	 */
	public PreProperty setDefaultValues(double[] defaultValues) {
		String[] temp = new String[defaultValues.length];
		for (int i = 0; i < defaultValues.length; i++)
	 ...
	 */
	public PreProperty setDefaultValue(boolean defaultValue) {
	 ...
	 */
	public PreProperty setDefaultValues(boolean[] defaultValues) {
		String[] temp = new String[defaultValues.length];
		for (int i = 0; i < defaultValues.length; i++)
	 ...
	 */
	public PreProperty setMinValue(int minValue) {
	 ...
	 */
	public PreProperty setMaxValue(int maxValue) {
	 ...
	 */
	public PreProperty setMinValue(double minValue) {
	 ...
	 */
	public PreProperty setMaxValue(double maxValue) {
	 ...
	 */
	public PreProperty setValidValues(String[] validValues) {
		this.validValues = validValues;
		return this;
	}
	 ...
	 */
	public PreProperty setValue(String value) {
		this.value = value;
		changed = true;
		return this;
	}
	 ...
	 */
	public PreProperty setValues(String[] values) {
		this.values = Arrays.copyOf(values, values.length);
		changed = true;
		return this;
	}
	 ...
	 */
	public PreProperty setValue(int value) {
	 ...
	 */
	public PreProperty setValue(boolean value) {
	 ...
	 */
	public PreProperty setValue(double value) {
	 ...
	 */
	public PreProperty setValues(boolean[] values) {
	 ...
	 */
	public PreProperty setValues(int[] values) {
		this.values = new String[values.length];
		for (int i = 0; i < values.length; i++)
			this.values[i] = String.valueOf(values[i]);
		changed = true;
	 ...
	 */
	public PreProperty setValues(double[] values) {
		this.values = new String[values.length];
		for (int i = 0; i < values.length; i++)
			this.values[i] = String.valueOf(values[i]);
		changed = true;
