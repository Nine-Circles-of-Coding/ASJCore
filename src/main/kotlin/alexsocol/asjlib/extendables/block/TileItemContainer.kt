    ...
    fun renderItem(tile: TileItemContainer) {
      ...
      if (itemstack != null) {
        ...
        Tessellator.instance.setBrightness(
            tile
                .getBlockType()
                .getMixedBrightnessForBlock(tile.worldObj, tile.xCoord, tile.yCoord, tile.zCoord))

        if (item === Items.compass) {
          val texturemanager = Minecraft.getMinecraft().textureManager
          texturemanager.bindTexture(TextureMap.locationItemsTexture)
          val textureatlassprite1 =
              (texturemanager.getTexture(TextureMap.locationItemsTexture) as TextureMap)
                  .getAtlasSprite(Items.compass.getIconIndex(entityitem.entityItem).iconName)
          ...
          if (textureatlassprite1 is TextureCompass) {
            ...
            textureatlassprite1.updateCompass(
                tile.worldObj,
                tile.xCoord.D,
                tile.zCoord.D,
                MathHelper.wrapAngleTo180_double(180 + tile.blockMetadata * 90.0),
                false,
                true)
          ...
          val textureatlassprite =
              (Minecraft.getMinecraft().textureManager.getTexture(TextureMap.locationItemsTexture)
                      as TextureMap)
                  .getAtlasSprite(Items.compass.getIconIndex(entityitem.entityItem).iconName)
