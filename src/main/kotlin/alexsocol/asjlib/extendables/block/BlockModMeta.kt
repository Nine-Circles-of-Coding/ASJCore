...
constructor(
  ...
  override fun registerBlockIcons(reg: IIconRegister) {
    icons =
        Array(subtypes) { reg.registerIcon("$modid:$folder$name${if (subtypes > 1) it else ""}") }
  }
  ...
  override fun getDamageValue(world: World, x: Int, y: Int, z: Int) =
