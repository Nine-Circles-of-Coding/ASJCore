...
open class ModelBipedNew : ModelBase() {
  ...
  override fun setRotationAngles(
    ...
    // if (heldItemLeft != 0) leftarm.rotateAngleX = leftarm.rotateAngleX * 0.5F - ((float)Math.PI /
    // 10F) * (float)heldItemLeft;
    // if (heldItemRight != 0) rightarm.rotateAngleX = rightarm.rotateAngleX * 0.5F -
