...
class HarmlessExplosion(
    worldObj: World,
    exploder: EntityPlayer?,
    explosionX: Double,
    explosionY: Double,
    explosionZ: Double,
    explosionSize: Float
  ...
  init {
    ...
    val list =
        getEntitiesWithinAABB(
            ...
            getBoundingBox(explosionX, explosionY, explosionZ).expand(explosionSize + 1))
      ...
      if (d4 <= 1.0) {
        ...
        if (d9 != 0.0) {
          ...
          entity.attackEntityFrom(
              ...
              ((d11 * d11 + d11) / 2.0 * 8.0 * explosionSize + 1.0).F)
