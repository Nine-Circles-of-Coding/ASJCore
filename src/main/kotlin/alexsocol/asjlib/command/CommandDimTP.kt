...
object CommandDimTP : CommandBase() {
  ...
  override fun processCommand(sender: ICommandSender, args: Array<String>) {
    try {
      ...
      val id = args[0].toInt()
      val w =
          MinecraftServer.getServer().worldServerForDimension(id)
              ?: throw NoWorldException("Loaded dimension is null")
      //			val s: ChunkCoordinates = sender.getBedLocation(id) ?: w.spawnPoint ?:
      // ChunkCoordinates(0, w.getHeightValue(0, 0) + 1, 0)
