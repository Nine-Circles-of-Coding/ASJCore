...
class ASJClassTransformer : IClassTransformer {
  ...
  override fun transform(
    ...
    transformedName
        as java.lang.String // fix of java.lang.ClassCircularityError: kotlin/text/StringsKt
    ...
    if (transformedName !=
        "alexsocol.patcher.asm.ASJClassTransformer\$ClassVisitorPotionMethodPublicizer")
        try {
          ...
          System.err.println(
              "Something went wrong while transforming class $transformedName. Ignore if everything is OK (this is NOT ASJLib error).")
          e.printStackTrace()
        }
    ...
    return when (transformedName) {
      ...
      "io.netty.channel.DefaultChannelPipeline" ->
          core { `DefaultChannelPipeline$ClassVisitor`(it) }
      "net.minecraft.client.network.NetHandlerPlayClient" ->
          core { `NetHandlerPlayClient$ClassVisitor`(it) }
      ...
      "net.minecraft.network.play.client.C17PacketCustomPayload" ->
          core { `C17PacketCustomPayload$ClassVisitor`(it) }
      "net.minecraft.server.management.ItemInWorldManager" ->
          core { `ItemInWorldManager$ClassVisitor`(it) }
  ...
  internal class ClassVisitorPotionMethodPublicizer(cv: ClassVisitor, val className: String) :
      ClassVisitor(ASM5, cv) {
    ...
    override fun visitMethod(
      ...
      var access = acc
      if (name == (if (OBF) "b" else "onFinishedPotionEffect") &&
          desc == (if (OBF) "(Lrw;)V" else "(Lnet/minecraft/potion/PotionEffect;)V")) {
        println("Publicizing onFinishedPotionEffect: $name$desc for $className")
        access = ACC_PUBLIC
      }
      if (name == (if (OBF) "a" else "onChangedPotionEffect") &&
          desc == (if (OBF) "(Lrw;Z)V" else "(Lnet/minecraft/potion/PotionEffect;Z)V")) {
  ...
  internal class `ItemInfo$ClassVisitor`(cv: ClassVisitor) : ClassVisitor(ASM5, cv) {
    ...
    override fun visitMethod(
      ...
      if (name == "load") {
        ...
        return `ItemInfo$load$MethodVisitor`(
    ...
    internal class `ItemInfo$load$MethodVisitor`(mv: MethodVisitor) : MethodVisitor(ASM5, mv) {
      ...
      override fun visitMethodInsn(
        ...
        if (opcode == INVOKESTATIC &&
            owner == "codechicken/nei/api/ItemInfo" &&
            name == "addSpawnEggs")
            return super.visitMethodInsn(
                opcode, "alexsocol/patcher/asm/ASJPatches", "patchNeiNoWither", desc, itf)
  ...
  internal class `NetHandlerPlayClient$ClassVisitor`(cv: ClassVisitor) : ClassVisitor(ASM5, cv) {
    ...
    override fun visitMethod(
      ...
      if (name == "handleEntityProperties" || (name == "a" && desc == "(Lil;)V")) {
        ...
        return `NetHandlerPlayClient$handleEntityProperties$MethodVisitor`(
            super.visitMethod(access, name, desc, signature, exceptions))
      }
    ...
    internal class `NetHandlerPlayClient$handleEntityProperties$MethodVisitor`(mv: MethodVisitor) :
  ...
  internal class `EffectRenderer$ClassVisitor`(cv: ClassVisitor) : ClassVisitor(ASM5, cv) {
    ...
    override fun visitMethod(
      ...
      if (name == "addEffect" || name == "a" && desc == "(Lbkm;)V") {
        ...
        return `EffectRenderer$addEffect$MethodVisitor`(
            super.visitMethod(access, name, desc, signature, exceptions))
      }
    ...
    internal class `EffectRenderer$addEffect$MethodVisitor`(mv: MethodVisitor) :
        MethodVisitor(ASM5, mv) {
        ...
        if (opcode == SIPUSH && operand == 4000) {
          when (PatcherConfigHandler.maxParticles) {
            in Byte.MIN_VALUE..Byte.MAX_VALUE ->
                super.visitIntInsn(BIPUSH, PatcherConfigHandler.maxParticles)
            in Short.MIN_VALUE..Short.MAX_VALUE ->
                super.visitIntInsn(SIPUSH, PatcherConfigHandler.maxParticles)
  ...
  internal class `CommandSummon$ClassVisitor`(cv: ClassVisitor) : ClassVisitor(ASM5, cv) {
    ...
    override fun visitMethod(
      ...
      return `CommandSummon$processCommand$MethodVisitor`(
          super.visitMethod(access, name, desc, signature, exceptions))
    }

    internal class `CommandSummon$processCommand$MethodVisitor`(mv: MethodVisitor) :
        MethodVisitor(ASM5, mv) {
      ...
      override fun visitMethodInsn(
        ...
        if ((owner == "net/minecraft/entity/DataWatcher" || owner == "te") && desc == "(I)B")
            super.visitMethodInsn(
                opcode, owner, if (OBF) "c" else "getWatchableObjectInt", "(I)I", itf)
  ...
  internal class `ItemGlassBottle$ClassVisitor`(cv: ClassVisitor) : ClassVisitor(ASM5, cv) {
    ...
    override fun visitMethod(
      ...
      if (name == "onItemRightClick" || name == "a" && desc == "(Ladd;Lahb;Lyz;)Ladd;") {
        ...
        return `ItemGlassBottle$onItemRightClick$MethodVisitor`(
            super.visitMethod(access, name, desc, signature, exceptions))
      }
    ...
    internal class `ItemGlassBottle$onItemRightClick$MethodVisitor`(mv: MethodVisitor) :
        MethodVisitor(ASM5, mv) {
      ...
      override fun visitFieldInsn(opcode: Int, owner: String?, name: String?, desc: String?) {
        if (name == "water" || name == "h")
            super.visitFieldInsn(
                GETSTATIC,
                if (OBF) "ajn" else "net/minecraft/init/Blocks",
                if (OBF) "j" else "water",
                if (OBF) "Laji;" else "Lnet/minecraft/block/Block;")
  ...
  internal class `JsonToNBT$ClassVisitor`(cv: ClassVisitor) : ClassVisitor(ASM5, cv) {
    ...
    override fun visitMethod(
      ...
      if (name == "func_150316_a" || name == "c") {
        ...
        return `JsonToNBT$func_150316_a$MethodVisitor`(
            super.visitMethod(access, name, desc, signature, exceptions))
      }
    ...
    internal class `JsonToNBT$func_150316_a$MethodVisitor`(mv: MethodVisitor) :
        MethodVisitor(ASM5, mv) {
  ...
  internal class `C17PacketCustomPayload$ClassVisitor`(cv: ClassVisitor) : ClassVisitor(ASM5, cv) {
    ...
    override fun visitMethod(
      ...
      if ((name == "<init>" && desc == "(Ljava/lang/String;[B)V") ||
          (name == "readPacketData" || name == "a" && desc == "(Let;)V") ||
          (name == "writePacketData" || name == "b" && desc == "(Let;)V")) {
        println("Visiting C17PacketCustomPayload methods: $name$desc")
        return `C17PacketCustomPayload$MethodVisitor`(
            super.visitMethod(access, name, desc, signature, exceptions))
      }
    ...
    internal class `C17PacketCustomPayload$MethodVisitor`(mv: MethodVisitor) :
        MethodVisitor(ASM5, mv) {
  ...
  internal class `ItemInWorldManager$ClassVisitor`(cv: ClassVisitor) : ClassVisitor(ASM5, cv) {
    ...
    override fun visitMethod(
      ...
      if (name == "onBlockClicked" || name == "a" && desc == "(IIII)V") {
        ...
        return `ItemRelic$onBlockClicked$MethodVisitor`(
            super.visitMethod(access, name, desc, signature, exceptions))
      }
    ...
    internal class `ItemRelic$onBlockClicked$MethodVisitor`(mv: MethodVisitor) :
        MethodVisitor(ASM5, mv) {
      ...
      override fun visitInsn(opcode: Int) {
        if (opcode == ACONST_NULL) {
          ...
          visitFieldInsn(
              GETFIELD,
              if (OBF) "mx" else "net/minecraft/server/management/ItemInWorldManager",
              if (OBF) "b" else "thisPlayerMP",
              if (OBF) "Lmw;" else "Lnet/minecraft/entity/player/EntityPlayerMP;")
        } else {
      ...
      override fun visitTypeInsn(opcode: Int, type: String) {
        if (opcode != CHECKCAST ||
            type != (if (OBF) "yz" else "net/minecraft/entity/player/EntityPlayer")) {
  ...
  internal class `TileEntityFurnace$ClassVisitor`(cv: ClassVisitor) : ClassVisitor(ASM5, cv) {
    ...
    override fun visitMethod(
      ...
      if (name == "readFromNBT" || (name == "a" && desc == "(Ldh;)V")) {
        ...
        return `TileEntityFurnace$readFromNBT$MethodVisitor`(
            super.visitMethod(access, name, desc, signature, exceptions))
      } else if (name == "writeToNBT" || (name == "b" && desc == "(Ldh;)V")) {
        println("Visiting TileEntityFurnace#writeToNBT: $name$desc")
        return `TileEntityFurnace$writeToNBT$MethodVisitor`(
            super.visitMethod(access, name, desc, signature, exceptions))
      }
    ...
    internal class `TileEntityFurnace$readFromNBT$MethodVisitor`(mv: MethodVisitor) :
        MethodVisitor(ASM5, mv) {
      ...
      override fun visitMethodInsn(
        ...
        if (name == "getShort" || (name == "e" && desc == "(Ljava/lang/String;)S")) {
          super.visitMethodInsn(
              opcode, owner, if (OBF) "f" else "getInteger", "(Ljava/lang/String;)I", itf)
        } else super.visitMethodInsn(opcode, owner, name, desc, itf)
      }
    }

    internal class `TileEntityFurnace$writeToNBT$MethodVisitor`(mv: MethodVisitor) :
        MethodVisitor(ASM5, mv) {
      ...
      override fun visitMethodInsn(
        ...
        if (name == "setShort" || (name == "a" && desc == "(Ljava/lang/String;S)V")) {
          super.visitMethodInsn(
              opcode, owner, if (OBF) "a" else "setInteger", "(Ljava/lang/String;I)V", itf)
        } else super.visitMethodInsn(opcode, owner, name, desc, itf)
      }
  ...
  internal class `World$ClassVisitor`(cv: ClassVisitor) : ClassVisitor(ASM5, cv) {
    ...
    override fun visitMethod(
      ...
      if (name == "updateEntityWithOptionalForce" || name == "a" && desc == "(Lsa;Z)V") {
        ...
        return `World$updateEntityWithOptionalForce$MethodVisitor`(
            super.visitMethod(access, name, desc, signature, exceptions))
      }
    ...
    internal class `World$updateEntityWithOptionalForce$MethodVisitor`(mv: MethodVisitor) :
        MethodVisitor(ASM5, mv) {
      ...
      override fun visitMethodInsn(
        ...
        if (opcode == INVOKEVIRTUAL &&
            owner == (if (OBF) "sa" else "net/minecraft/entity/Entity") &&
            (name == (if (OBF) "ab" else "updateRidden") || name == if (OBF) "h" else "onUpdate") &&
            desc == "()V" &&
            !itf) {
          mv.visitMethodInsn(
              INVOKESTATIC,
              "alexsocol/patcher/event/EntityUpdateEvent",
              "instantiate",
              if (OBF) "(Lsa;)Lalexsocol/patcher/event/EntityUpdateEvent;"
              else "(Lnet/minecraft/entity/Entity;)Lalexsocol/patcher/event/EntityUpdateEvent;",
              false)
          ...
          mv.visitMethodInsn(
              INVOKEVIRTUAL, if (OBF) "sa" else "net/minecraft/entity/Entity", name, "()V", false)
          mv.visitLabel(label)
          mv.visitFrame(
              F_APPEND, 1, arrayOf<Any>("alexsocol/patcher/event/EntityUpdateEvent"), 0, null)
          mv.visitMethodInsn(
              INVOKESTATIC, "alexsocol/patcher/event/EntityUpdateEvent", "stub", "()V", false)
        } else super.visitMethodInsn(opcode, owner, name, desc, itf)
      }
    }
  }
  ...
  internal class `BlockCustomOre$ClassVisitor`(cv: ClassVisitor) : ClassVisitor(ASM5, cv) {
    ...
    override fun visitMethod(
      ...
      if (name == "addHitEffects") {
        ...
        return `BlockCustomOre$addHitEffects$MethodVisitor`(
            super.visitMethod(access, name, desc, signature, exceptions))
      }
    ...
    internal class `BlockCustomOre$addHitEffects$MethodVisitor`(mv: MethodVisitor) :
        MethodVisitor(ASM5, mv) {
  ...
  inline fun core(
      frames: Int = ClassReader.EXPAND_FRAMES,
      lambda: (ClassVisitor) -> ClassVisitor
  ): ByteArray {
