...
abstract class LivingPotionEvent(entity: EntityLivingBase, val effect: PotionEffect) :
    LivingEvent(entity) {
  ...
  abstract class Change(
    ...
    @Cancelable
    @Deprecated("Unimplemented", level = DeprecationLevel.ERROR)
    class Pre(entity: EntityLivingBase, pe: PotionEffect, update: Boolean) :
        Change(entity, pe, update)

    class Post(entity: EntityLivingBase, pe: PotionEffect, update: Boolean) :
        Change(entity, pe, update)
  }

  abstract class Remove(entity: EntityLivingBase, pe: PotionEffect) :
      LivingPotionEvent(entity, pe) {
