...
val ServerStateEvent.save: String
  get() = MinecraftServer.getServer().entityWorld.saveHandler.worldDirectory.absolutePath
val ServerStartingEvent.save: String
  get() = event.server.entityWorld.saveHandler.worldDirectory.absolutePath
