...
import alexsocol.asjlib.mixins.GameDataMixin
...
object PatcherMain {
	...
	fun preInit(e: FMLPreInitializationEvent) {
		...
		noItems.forEach { block ->
            (GameDataMixin.invokeGetMain() as GameDataMixin).invokeRegisterItem(ItemBlock(block), Block.blockRegistry.getNameForObject(block) + "_item", Block.getIdFromBlock(block))
		}
	}
